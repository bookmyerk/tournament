...
def testPairings():
    ...
    ##deleteMatches()
    ##deletePlayers()
    registerPlayer("Bill Smith")
    registerPlayer("Jane Austin")
    registerPlayer("Sam Jones")
    registerPlayer("Tammy Castle")
    registerPlayer("Rich Price")
    registerPlayer("Violet Rose")
...
if __name__ == '__main__':
    ...
    reportMatch(56,53)
    reportMatch(55,51)
    result = swissPairings()
    print "matched pairs ", result
